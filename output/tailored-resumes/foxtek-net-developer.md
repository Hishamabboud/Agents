...
Backend-focused .NET developer with experience building scalable APIs, cloud-deployed applications, and robust backend services using C#, .NET Core, and ASP.NET. Comfortable working across the full stack with a strong preference for clean, maintainable backend architectures.

## Professional Experience

### Software Service Engineer — Actemium (VINCI Energies), Eindhoven
*July 2025 — Present*
- Develop custom backend solutions and API integrations using .NET, C#, and ASP.NET for industrial clients
- Build and optimize database layers and REST API connections for manufacturing process systems
- Provide full-stack development and technical support for Manufacturing Execution Systems (MES)
...
- Architected full-stack solution with Python/Flask REST API backend, deployed on cloud infrastructure
...
## Skills
- Languages: C#, Python, SQL, JavaScript, Visual Basic
- Frameworks: .NET Core, ASP.NET, Flask, React, Locust, Pytest
- Tools: Azure, Docker, Kubernetes, Git, Jira, Active Directory
- Domains: REST API Development, Cloud Deployment, Backend Architecture, CI/CD, Agile/Scrum
