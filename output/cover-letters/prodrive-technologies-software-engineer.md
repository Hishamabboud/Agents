Dear Prodrive Technologies Recruitment Team,
...
I bring a blend of software engineering skills (Python, C#, .NET, Azure, Docker, Kubernetes) and manufacturing domain knowledge that is well-suited for Prodrive's multi-disciplinary R&D environment. My entrepreneurial initiative with CogitatAI demonstrates my drive to build innovative solutions beyond my day job.

I am based in Eindhoven and would welcome the opportunity to discuss how I can contribute to Prodrive Technologies' software engineering team.
