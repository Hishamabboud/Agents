#!/usr/bin/env python3
"""Batch submit v13 — 5 new companies found 2026-07-06 via deeper LinkedIn
pagination (pages 5-8 on top 4 keywords) plus a new source, Jobbird.nl.
...
CANDIDATES = [
    {"company": 'Inpact', "slug_company": 'inpact',
     "offer_slug": 'backend-developer', "offer_id": 1496127,
     "role": 'Backend Developer', "location": 'Hoofddorp'},
    {"company": 'Foleon', "slug_company": 'foleon',
     "offer_slug": 'backend-developer-2607', "offer_id": 2678261,
     "role": 'Backend Developer', "location": 'Amsterdam'},
    {"company": 'ViCentra B.V.', "slug_company": 'vicentra',
     "offer_slug": 'software-engineer-android', "offer_id": 2553618,
     "role": 'Software Engineer, Android', "location": 'Utrecht'},
    {"company": 'Goodzo', "slug_company": 'goodzo',
     "offer_slug": 'senior-cloud-engineer', "offer_id": 2417680,
     "role": 'Senior Cloud Engineer', "location": 'Zoetermeer'},
    {"company": 'Portbase', "slug_company": 'portbase',
     "offer_slug": 'full-stack-developer-1', "offer_id": 1200634,
     "role": 'Full-Stack Developer', "location": 'Rotterdam'},
    {"company": 'Portbase', "slug_company": 'portbase',
     "offer_slug": 'senior-software-engineer', "offer_id": 2093114,
     "role": 'Senior Software Engineer', "location": 'Rotterdam'},
]
...
def main():
    ...
    next_id = max((a.get("id", 0) for a in apps if isinstance(a.get("id"), int)), default=395) + 1
