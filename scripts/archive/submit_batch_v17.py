#!/usr/bin/env python3
"""Batch submit v17 — 3 new companies found 2026-07-06 via an eighth LinkedIn
...
CANDIDATES = [
    {"company": 'Optics11', "slug_company": 'optics11',
     "offer_slug": 'data-ml-infrastructure-engineer', "offer_id": 2662532,
     "role": 'Data & ML Infrastructure Engineer', "location": 'Amsterdam'},
    {"company": 'Manometric', "slug_company": 'manometric',
     "offer_slug": 'full-stack-developer-1', "offer_id": 2661766,
     "role": 'Full Stack Developer', "location": 'Den Haag'},
    {"company": 'RIFT', "slug_company": 'rift',
     "offer_slug": 'medior-systems-engineer', "offer_id": 2668774,
     "role": 'Medior Systems Engineer', "location": 'Eindhoven'},
]
...
def main():
    ...
    next_id = max((a.get("id", 0) for a in apps if isinstance(a.get("id"), int)), default=435) + 1
