#!/usr/bin/env python3
"""Batch submit v22 — round 26. First full-time sweep run across BOTH the
...
CANDIDATES_PATH = Path("/tmp/claude-0/-home-user-Agents/9fd85063-ee93-588d-a736-933ead644540/scratchpad/final_r26.json")
