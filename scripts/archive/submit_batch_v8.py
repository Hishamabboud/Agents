#!/usr/bin/env python3
"""Batch submit v8 — 2 new companies found 2026-07-01 (round 11 deep search).
...
CANDIDATES = [
    {"company": "Nsecure B.V.", "slug_company": "nsecure",
     "offer_slug": "field-service-engineer", "offer_id": 426738,
     "role": "Field Service Engineer", "location": "Barendrecht"},
    {"company": "Supply Value (Next Senz)", "slug_company": "supplyvalue",
     "offer_slug": "junior-data-ai-consultant-next-senz-bv", "offer_id": 2318931,
     "role": "Junior Data & AI Consultant", "location": "Zeist"},
]
...
def main():
    ...
    next_id = max((a.get("id", 0) for a in apps if isinstance(a.get("id"), int)), default=310) + 1
