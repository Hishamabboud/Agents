#!/usr/bin/env python3
"""Batch submit v18 — 4 Belgium roles, newly in scope after geography broadened
job-listing sweep (10 fresh keywords x 4 pages: Industry 4.0, Digital Twin,
Simulation, Vision System, Robotics, Terraform, CI/CD, Build Engineer, Java,
Scientific Software Engineer). Live-verified via Recruitee API before
submission."""
...
CANDIDATES = [
    {"company": 'The Automation Group', "slug_company": 'automation',
     "offer_slug": 'test-engineer', "offer_id": 2658606,
     "role": 'Test Engineer', "location": 'Halle, BE'},
    {"company": 'Octiva', "slug_company": 'octiva',
     "offer_slug": 'experienced-seniormedior-mobile-developer-react-native', "offer_id": 2516288,
     "role": 'Experienced Senior/Medior Mobile Developer (React Native)', "location": 'Leuven, BE'},
    {"company": 'Octiva', "slug_company": 'octiva',
     "offer_slug": 'experienced-robot-software-engineer-1', "offer_id": 2258969,
     "role": 'Experienced Robot Software Engineer', "location": 'Leuven, BE'},
    {"company": 'Datashift', "slug_company": 'datashift',
     "offer_slug": 'ai-engineer', "offer_id": 2673175,
     "role": 'AI Engineer', "location": 'Mechelen/Leuven/Gent, BE'},
]
...
def build_cover_letter(company, role, location):
    return (
        ...
        f"I am based in Eindhoven in the Netherlands, near the Belgian border, and am open "
        f"to working in Belgium as well as across the Netherlands. I am fluent in Dutch and "
        f"English. I would welcome the opportunity to discuss how my skills and experience "
        f"can benefit {company}.\n\n"
...
def main():
    ...
    next_id = max((a.get("id", 0) for a in apps if isinstance(a.get("id"), int)), default=438) + 1
