#!/usr/bin/env python3
"""Batch submit v7 — executes previously-prepared v5/v6 batches (never run) plus
5 new companies found 2026-07-01. All offers live-verified via Recruitee API before submission."""
...
CANDIDATES = [
    # --- from prepared-but-never-executed batch v5 (2026-06-30) ---
    ...
    # --- from prepared-but-never-executed batch v6 (2026-06-30) ---
    ...
    # --- new companies found 2026-07-01 (live-verified via Recruitee API) ---
    {"company": "Sioux High Tech Software", "slug_company": "sioux",
     "offer_slug": "net-engineer", "offer_id": 31974,
     "role": ".NET Engineer / Tech Lead", "location": "Netherlands"},
    {"company": "Ascending AI", "slug_company": "ascendingai",
     "offer_slug": "full-stack-ai-engineer", "offer_id": 2520991,
     "role": "Full Stack AI Engineer", "location": "Amsterdam"},
    {"company": "Enersee", "slug_company": "enersee",
     "offer_slug": "full-stack-developer", "offer_id": 2243114,
     "role": "Full Stack Developer", "location": "Netherlands"},
    {"company": "SKM Group", "slug_company": "skmgroup",
     "offer_slug": "experienced-net-developer", "offer_id": 1081001,
     "role": "Experienced .NET Developer", "location": "Netherlands"},
    {"company": "Topic Software Development", "slug_company": "topicsoftwaredevelopment",
     "offer_slug": "senior-software-engineer-with-practical-devops-experience-4", "offer_id": 2632268,
     "role": "Senior Software Engineer with practical DevOps experience", "location": "Best, Noord-Brabant"},
]
