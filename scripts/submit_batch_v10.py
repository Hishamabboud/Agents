#!/usr/bin/env python3
"""Batch submit v10 — 20 new companies found 2026-07-05 via a deeper LinkedIn
job-listing sweep (12 keywords x 4 pages, correctly paginated at 60-result
increments — the prior round's pagination bug re-fetched the same page 3x).
...
CANDIDATES = [
    {"company": 'ITIS', "slug_company": 'itis',
     "offer_slug": 'azure-cloud-engineer', "offer_id": 1617001,
     "role": 'Cloud Engineer Managed Services', "location": 'Barendrecht'},
    {"company": 'ITIS', "slug_company": 'itis',
     "offer_slug": 'traineeship-software-developers', "offer_id": 1051388,
     "role": 'Traineeship Software Developer', "location": 'Barendrecht'},
    {"company": 'Hypersolid', "slug_company": 'hypersolid',
     "offer_slug": 'full-stack-developer', "offer_id": 2218986,
     "role": 'Full-Stack Developer', "location": 'Amsterdam'},
    {"company": 'ROCSYS', "slug_company": 'rocsys',
     "offer_slug": 'full-stack-typescript-developer', "offer_id": 2520409,
     "role": 'Full Stack TypeScript Developer', "location": 'Rijswijk'},
    {"company": 'IG&H', "slug_company": 'igh',
     "offer_slug": 'senior-data-scientist', "offer_id": 2624996,
     "role": 'Senior Data Scientist', "location": 'Utrecht'},
    {"company": 'IG&H', "slug_company": 'igh',
     "offer_slug": 'medior-data-engineer-3', "offer_id": 2487656,
     "role": 'Medior Data Engineer', "location": 'Utrecht'},
    {"company": 'PB Web Media', "slug_company": 'pbwebmedia',
     "offer_slug": 'data-scientist-32-40-uur', "offer_id": 2592167,
     "role": 'Data Scientist | 32-40 uur', "location": 'Haarlem'},
    {"company": 'PB Web Media', "slug_company": 'pbwebmedia',
     "offer_slug": 'machine-learning-engineer-32-40-uur', "offer_id": 2506188,
     "role": 'Machine Learning Engineer | 32-40 uur', "location": 'Haarlem'},
    {"company": 'Louwman Group', "slug_company": 'louwman',
     "offer_slug": 'data-scientist-4', "offer_id": 2590402,
     "role": 'Data Scientist', "location": 'Raamsdonksveer'},
    {"company": 'Louwman Group', "slug_company": 'louwman',
     "offer_slug": 'data-platform-engineer', "offer_id": 2477575,
     "role": 'Data Platform Engineer', "location": 'Raamsdonksveer'},
    {"company": 'Budget Thuis', "slug_company": 'budgetthuis',
     "offer_slug": 'platform-engineer-3', "offer_id": 2587679,
     "role": 'Platform Engineer', "location": 'Amsterdam'},
    {"company": 'Budget Thuis', "slug_company": 'budgetthuis',
     "offer_slug": 'senior-platform-engineer', "offer_id": 2547332,
     "role": 'Senior Platform Engineer', "location": 'Amsterdam'},
    {"company": 'BridgeFund', "slug_company": 'bridgefund',
     "offer_slug": 'platform-engineer-3', "offer_id": 2650079,
     "role": 'Platform Engineer', "location": 'Amsterdam'},
    {"company": 'BridgeFund', "slug_company": 'bridgefund',
     "offer_slug": 'senior-platform-engineer', "offer_id": 2647137,
     "role": 'Senior Platform Engineer', "location": 'Amsterdam'},
    {"company": 'Veldsink Groep', "slug_company": 'veldsinkgroep',
     "offer_slug": 'data-engineer-1', "offer_id": 2649956,
     "role": 'Data Engineer', "location": 'Nuenen'},
    {"company": 'Veldsink Groep', "slug_company": 'veldsinkgroep',
     "offer_slug": 'data-scientist', "offer_id": 2571224,
     "role": 'Data Scientist', "location": 'Nuenen'},
    {"company": 'Transavia', "slug_company": 'transavia',
     "offer_slug": 'medior-fullstack-developer', "offer_id": 2645808,
     "role": 'Medior Fullstack Developer', "location": 'Hoofddorp'},
    {"company": 'Transavia', "slug_company": 'transavia',
     "offer_slug": 'medior-platform-engineer', "offer_id": 2645797,
     "role": 'Medior Platform Engineer', "location": 'Hoofddorp'},
    {"company": 'Kaizo', "slug_company": 'kaizo',
     "offer_slug": 'platform-engineer', "offer_id": 2175358,
     "role": 'Google Cloud Platform Engineer', "location": 'Amsterdam'},
    {"company": 'MedApp', "slug_company": 'medapp',
     "offer_slug": 'senior-backend-developer', "offer_id": 2637776,
     "role": 'Senior Backend Developer', "location": 'Eindhoven'},
]
...
def main():
    ...
    next_id = max((a.get("id", 0) for a in apps if isinstance(a.get("id"), int)), default=339) + 1
