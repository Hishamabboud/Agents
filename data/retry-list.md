# Failed & Skipped Applications

These positions were not successfully submitted. They may be worth retrying manually.

## Failed

| Company | Role | URL |
|---|---|---|
| CIMSOLUTIONS | Python Software Engineer | https://www.cimsolutions.nl/solliciteren/?python-software-engineer-ah5ashpvv9cksst8 |
| CM.com | Medior Backend Developer (Conversational AI Cloud) | https://jobs.cm.com/o/medior-backend-developer |
| VI Company | Senior Backend Developer C# .NET | https://englishjobsearch.nl/clickout/bf3bc3215f130198 |

## Skipped (worth retrying)

| Company | Role | URL |
|---|---|---|
| ALTEN Nederland | Software Engineer (Python/C#) | https://englishjobsearch.nl/clickout/bc0a1044202977b3 |
| Garmin Nederland | .Net Back End Developer | https://nl.linkedin.com/jobs/view/net-back-end-developer-at-garmin-nederland-4377142333 |
| KUBUS / BIMcollab | Software Engineer | https://jobs.bimcollab.com/o/software-engineer-3 |
| Scholt Energy | .NET Software Engineer | https://www.scholt.nl/en/working-at/job-vacancy-overview/net-software-engineer/ |
| Sendcloud | Medior Backend Engineer (Python) | https://jobs.sendcloud.com/jobs/8390536002-cg |
| Sopra Steria | .NET Developer | https://nl.linkedin.com/jobs/view/net-developer-at-sopra-steria-4376750270 |
| Trifork | Medior .NET Developer | https://trifork.homerun.co/medior-net-developer-eindhoven/en/apply |
| Zetes Goods ID | Software Engineer | https://nl.linkedin.com/jobs/view/software-engineer-at-zetes-goods-id-4375182087 |

## Closed (no longer available)

| Company | Role | URL |
|---|---|---|
| Coolblue | C# Developer | https://www.coolblue.nl/en/vacancies/c-developer |
| GoodHabitz | Backend Engineer (C# & NodeJS) | https://builtin.com/job/backend-engineer/3511984 |
| Inmation BNX | Experienced C# Developer (Backend) | https://inmation.bamboohr.com/jobs/view.php?id=41 |

## Action Required (email applications)

| Company | Role | Contact | URL |
|---|---|---|---|
| Watch-E | .NET Software Developer | karel@watch-e.nl | https://www.watch-e.nl/vacature/vacature-software-developer |
